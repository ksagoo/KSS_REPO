...
Dim strFileIn, strFileOut, strExec, boIsUnicode, intButton, strFileName, strTmpDir 
...
If boIsUnicode Then
   ...
   If intButton = YES Then
       ...
       strTmpDir = "C:\tmp\"
       strFileName = fso.GetFileName( strFileIn )
       strFileOut = strTmpDir & strFileName & ".bak"
       ...
       strExec = "CMD /C TYPE " & strFileOut & " > " & strTmpDir & strFileName
       rc = wsh.Run(strExec,0,1)
